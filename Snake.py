...
class Snake:
    ...
    def draw(self):
        ...
        turtle.goto(self.home[0], self.home[1])
        turtle.color("red")
        turtle.pendown()
        turtle.begin_fill()
        turtle.goto(self.home[0] - self.size, self.home[1])
        turtle.goto(self.home[0] - self.size, self.home[1] + self.size)
        turtle.goto(self.home[0], self.home[1] + self.size)
        turtle.goto(self.home[0], self.home[1])
        turtle.end_fill()
        turtle.penup()
    ...
    def move(self, direction):
        ...
        if direction == "right":
            self.home[0] = self.home[0] + self.size
        elif direction == "left":
            self.home[0] = self.home[0] - self.size
        elif direction == "up":
            self.home[1] = self.home[1] + self.size
        else:
            self.home[1] = self.home[1] - self.size
    ...
    def hit_bounds(self, bounds): #left, top, right, bottom bounding box
        ...
        if self.home[0] <= 281 and self.home[1] <= 279 and self.home[0] > -281 and self.home[1] >= -280:
            return False
        else:
            return True
        # pass
